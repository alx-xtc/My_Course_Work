...
public class BuyProductProblemTest extends TestUtil {

    @DataProvider(name = "csvUserList")
    public static Object[][] readUsersFromCsvFile() throws IOException, CsvException {
        return CsvHelper.readCsvFile("src/test/resources/problemUserBuyProduct.csv");
    }

    @Test(dataProvider = "csvUserList")
    public void BuyProductTest(String userName, String password, String product1,
